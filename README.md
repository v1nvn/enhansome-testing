...
# Awesome Testing [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 466,101 | 🐛 75 | 📅 2026-05-05 [![Dead link checker](https://github.com/TheJambo/awesome-testing/actions/workflows/404-links.yml/badge.svg)](https://github.com/TheJambo/awesome-testing/actions/workflows/404-links.yml) ⭐ 2,265 | 🐛 4 | 📅 2026-05-12 with stars
...
Finally, I'm sure everyone who reads this list has one thing they want to add. Please read the [How to Contribute](https://github.com/TheJambo/awesome-testing/blob/master/CONTRIBUTING.md) ⭐ 2,265 | 🐛 4 | 📅 2026-05-12 page and add to the list. :)
...
* [Keploy](https://github.com/keploy/keploy) ⭐ 17,229 | 🐛 634 | 🌐 Go | 📅 2026-05-13 - API Testing Platform that automatically generates unit test cases along with dependency mocks.
...
* [Nuclei Scanner](https://github.com/projectdiscovery/nuclei) ⭐ 28,330 | 🐛 129 | 🌐 Go | 📅 2026-05-13 - nuclie is automated scanner for common vulnerbilty finding on site.
* [OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,122 | 🐛 857 | 🌐 Java | 📅 2026-05-12 - Intercepting proxy for HTTP traffic manipulation, security scanning, and exploitation.
...
* [promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 21,231 | 🐛 270 | 🌐 TypeScript | 📅 2026-05-14 - Open-source framework for testing and red teaming LLM applications. Compare prompts, test RAG architectures, run multi-turn adversarial attacks, and catch security vulnerabilities with CI/CD integration.
* [voicetest](https://github.com/voicetestdev/voicetest) ⭐ 20 | 🐛 1 | 🌐 Python | 📅 2026-05-14 - Open-source test harness for voice AI agents supporting Retell, VAPI, LiveKit, and Bland with autonomous simulations and LLM-based evaluation.
...
* [WireMock](https://github.com/wiremock/wiremock) ⭐ 7,241 | 🐛 482 | 🌐 Java | 📅 2026-05-13 - Open source HTTP mock engine written in Java. Embed in your test code, run as a standalone process, or deploy via Docker.
...
* [fakecloud](https://github.com/faiscadev/fakecloud) ⭐ 289 | 🐛 5 | 🌐 Rust | 📅 2026-05-14 - Free, open-source local AWS cloud emulator for integration tests, with 23 services at 100% conformance and first-party test-assertion SDKs in 6 languages.
* [mockd](https://github.com/getmockd/mockd) ⭐ 120 | 🐛 12 | 🌐 Go | 📅 2026-05-13 - Open-source multi-protocol mock server supporting HTTP, gRPC, GraphQL, WebSocket, MQTT, and SOAP with chaos engineering and proxy recording.
...
* [Sherlo](https://github.com/sherlo-io/sherlo) ⭐ 77 | 🐛 2 | 🌐 TypeScript | 📅 2026-05-11 - Visual testing platform for React Native Storybook. Captures screenshots on iOS and Android simulators in the cloud and detects visual changes automatically.
...
* [Hercules](https://github.com/test-zeus-ai/testzeus-hercules) ⭐ 1,010 | 🐛 30 | 🌐 Python | 📅 2026-05-08 - Open-source end-to-end testing agent.
* [playwright-bdd](https://github.com/vitalets/playwright-bdd) ⭐ 681 | 🐛 50 | 🌐 TypeScript | 📅 2026-05-13 - BDD-style Playwright testing.
* [flutter-skill](https://github.com/ai-dashboad/flutter-skill) ⭐ 248 | 🐛 3 | 🌐 Dart | 📅 2026-04-15 - AI-powered E2E testing via MCP for Flutter, React Native, iOS, Android, Electron, Tauri, KMP, and .NET MAUI. Zero test code.
...
* [TestLink](https://github.com/TestLinkOpenSourceTRMS/testlink-code) ⭐ 1,595 | 🐛 49 | 🌐 PHP | 📅 2025-12-08 - Open-source test case management system.
* [Kiwi TCMS](https://github.com/kiwitcms/Kiwi) ⭐ 1,193 | 🐛 144 | 🌐 Python | 📅 2026-05-13 - Open-source test case management.
...
* [Foundry](https://github.com/foundry-rs/foundry) ⭐ 10,343 | 🐛 638 | 🌐 Rust | 📅 2026-05-14 - Fast, modular toolkit for Ethereum development.
...
* [ai-natural-language-tests](https://github.com/aiqualitylab/ai-natural-language-tests) ⭐ 17 | 🐛 10 | 🌐 Python | 📅 2026-05-13 - Generates Cypress and Playwright E2E tests from natural language requirements using LangGraph, ChromaDB, and multi-provider LLM support.
...
* [Captura](https://github.com/MathewSachin/Captura) ⭐ 10,681 | 🐛 115 | 🌐 C# | 📅 2026-04-10 - Open-source video recording tool.
...
* [Learn to Code](https://github.com/karlhorky/learn-to-program) ⭐ 4,786 | 🐛 23 | 📅 2025-05-10 - Another awesome list for developer training
* [FrontRow](https://github.com/majdukovic/frontrow) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2026-05-12 - Open source React Native mobile app built as a hands on training surface for QA automation. Cross platform testIDs work across Maestro, Appium, Espresso and XCUITest, and a deep QA Debug Menu lets trainees force the failure modes that actually bite in production (4xx, 5xx, timeouts, offline, denied permissions, declined IAP, expired tokens) without flaky backends.
...
* [Naughty Strings](https://github.com/minimaxir/big-list-of-naughty-strings) ⭐ 47,627 | 🐛 108 | 🌐 Python | 📅 2024-04-18 - This is the famous list of Naughty Strings. If you're doing some field validation, look no further for inspiration.
* [Falsehoods](https://github.com/kdeldycke/awesome-falsehood) ⭐ 27,350 | 🐛 3 | 📅 2026-04-27 - A funny and educational list of why nothing in Software Development is ever easy. Think you can store a marriage in a DB?
...
* [The Original](https://github.com/sindresorhus/awesome) ⭐ 466,101 | 🐛 75 | 📅 2026-05-05 - The awesome list of awesome lists.
* [Security](https://github.com/sbilly/awesome-security) ⭐ 14,330 | 🐛 213 | 📅 2026-01-11 - This is mostly focused on Infrastructure, but if you're testing a series of systems, this is very useful.
* [Application Security](https://github.com/paragonie/awesome-appsec) ⭐ 6,909 | 🐛 35 | 🌐 PHP | 📅 2025-02-22 - Incredibly extensive, but you'll find something to fit the bill.
* [How They Test](https://github.com/abhivaikar/howtheytest) ⭐ 6,763 | 🐛 8 | 🌐 TypeScript | 📅 2026-04-16 - A curated collection of public resources from tech companies on how they test their software and build a quality culture
* [Learn to Code](https://github.com/karlhorky/learn-to-program) ⭐ 4,786 | 🐛 23 | 📅 2025-05-10 - Learning to code, for those looking to make the move to automation
...
* [Awesome Performance Engineering](https://github.com/be-next/awesome-performance-engineering) ⭐ 23 | 🐛 1 | 📅 2026-04-27 - A curated collection of tools and resources for performance engineering, covering observability and performance testing.

## QA and Testing Road Map

* [How to start QA and Testing career](https://github.com/fityanos/Quality-Assurance-Road-Map) ⭐ 2,110 | 🐛 8 | 📅 2021-12-30 - A wide and rich list of strategies, topics, and skills that you need to start a career in software testing and automation.
...
contributors](https://github.com/TheJambo/awesome-testing/graphs/contributors) ⭐ 2,265 | 🐛 4 | 📅 2026-05-12
