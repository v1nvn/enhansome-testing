...
# Awesome Testing [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 460,012 | 🐛 67 | 📅 2026-04-19 [![Dead link checker](https://github.com/TheJambo/awesome-testing/actions/workflows/404-links.yml/badge.svg)](https://github.com/TheJambo/awesome-testing/actions/workflows/404-links.yml) ⭐ 2,256 | 🐛 2 | 📅 2026-04-22 with stars
...
Finally, I'm sure everyone who reads this list has one thing they want to add. Please read the [How to Contribute](https://github.com/TheJambo/awesome-testing/blob/master/CONTRIBUTING.md) ⭐ 2,256 | 🐛 2 | 📅 2026-04-22 page and add to the list. :)
...
* [Keploy](https://github.com/keploy/keploy) ⭐ 17,175 | 🐛 633 | 🌐 Go | 📅 2026-04-29 - API Testing Platform that automatically generates unit test cases along with dependency mocks.
...
* [Nuclei Scanner](https://github.com/projectdiscovery/nuclei) ⭐ 28,130 | 🐛 129 | 🌐 Go | 📅 2026-04-27 - nuclie is automated scanner for common vulnerbilty finding on site.
* [OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,059 | 🐛 858 | 🌐 Java | 📅 2026-04-28 - Intercepting proxy for HTTP traffic manipulation, security scanning, and exploitation.
...
* [promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 20,678 | 🐛 265 | 🌐 TypeScript | 📅 2026-04-29 - Open-source framework for testing and red teaming LLM applications. Compare prompts, test RAG architectures, run multi-turn adversarial attacks, and catch security vulnerabilities with CI/CD integration.
* [voicetest](https://github.com/voicetestdev/voicetest) ⭐ 16 | 🐛 0 | 🌐 Python | 📅 2026-04-22 - Open-source test harness for voice AI agents supporting Retell, VAPI, LiveKit, and Bland with autonomous simulations and LLM-based evaluation.
...
* [Litmus](https://github.com/rylinjames/litmus) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2026-03-26 - Record and replay AI agent LLM calls deterministically for testing and CI, with fault injection and reliability scoring.
* [AgentSkeptic](https://github.com/jwekavanagh/agentskeptic) ⭐ 0 | 🐛 2 | 🌐 TypeScript | 📅 2026-04-29 - Verifies AI/agent workflows by checking database state after execution, comparing expected vs observed outcomes with read-only SQL.

### Service Virtualization

* [WireMock](https://github.com/wiremock/wiremock) ⭐ 7,225 | 🐛 476 | 🌐 Java | 📅 2026-04-29 - Open source HTTP mock engine written in Java. Embed in your test code, run as a standalone process, or deploy via Docker.
* [DeepfakeHTTP](https://github.com/xnbox/DeepfakeHTTP) ⭐ 528 | 🐛 8 | 🌐 Java | 📅 2022-08-05 - Web server using HTTP dumps as a response source for API simulation.
* [fakecloud](https://github.com/faiscadev/fakecloud) ⭐ 261 | 🐛 1 | 🌐 Rust | 📅 2026-04-29 - Free, open-source local AWS cloud emulator for integration tests, with 23 services at 100% conformance and first-party test-assertion SDKs in 6 languages.
* [mockd](https://github.com/getmockd/mockd) ⭐ 120 | 🐛 13 | 🌐 Go | 📅 2026-04-28 - Open-source multi-protocol mock server supporting HTTP, gRPC, GraphQL, WebSocket, MQTT, and SOAP with chaos engineering and proxy recording.
...
* [Sherlo](https://github.com/sherlo-io/sherlo) ⭐ 76 | 🐛 2 | 🌐 TypeScript | 📅 2026-04-29 - Visual testing platform for React Native Storybook. Captures screenshots on iOS and Android simulators in the cloud and detects visual changes automatically.
...
* [Ferrum](https://github.com/rubycdp/ferrum) ⭐ 2,004 | 🐛 36 | 🌐 Ruby | 📅 2026-04-22 - Chrome automation via CDP with a high-level Ruby API.
* [Hercules](https://github.com/test-zeus-ai/testzeus-hercules) ⭐ 992 | 🐛 28 | 🌐 Python | 📅 2026-04-23 - Open-source end-to-end testing agent.
* [playwright-bdd](https://github.com/vitalets/playwright-bdd) ⭐ 666 | 🐛 50 | 🌐 TypeScript | 📅 2026-04-22 - BDD-style Playwright testing.
* [flutter-skill](https://github.com/ai-dashboad/flutter-skill) ⭐ 219 | 🐛 3 | 🌐 Dart | 📅 2026-04-15 - AI-powered E2E testing via MCP for Flutter, React Native, iOS, Android, Electron, Tauri, KMP, and .NET MAUI. Zero test code.
...
* [TestLink](https://github.com/TestLinkOpenSourceTRMS/testlink-code) ⭐ 1,594 | 🐛 46 | 🌐 PHP | 📅 2025-12-08 - Open-source test case management system.
* [Kiwi TCMS](https://github.com/kiwitcms/Kiwi) ⭐ 1,185 | 🐛 156 | 🌐 Python | 📅 2026-04-29 - Open-source test case management.
...
* [Synth](https://github.com/getsynth/synth) ⭐ 1,480 | 🐛 98 | 🌐 Rust | 📅 2024-09-27 - Open-source test data generator.
* [Touca](https://github.com/trytouca/trytouca) ⭐ 510 | 🐛 7 | 🌐 TypeScript | 📅 2024-08-04 - Continuous regression testing for behavioral and performance comparisons.
...
* [VertaaUX CLI](https://github.com/VertaaUX/cli) ⭐ 0 | 🐛 0 | 📅 2026-04-17 - UX, accessibility, and conversion audits from the terminal and CI, with score-based quality gates and PR regression detection.
...
* [Foundry](https://github.com/foundry-rs/foundry) ⭐ 10,309 | 🐛 618 | 🌐 Rust | 📅 2026-04-29 - Fast, modular toolkit for Ethereum development.
...
* [OpenTester](https://github.com/kznr02/OpenTester) ⭐ 24 | 🐛 0 | 🌐 Python | 📅 2026-03-23 - MCP-First Testing Framwork: AI Agents Can Now Test Like Humans
* [ai-natural-language-tests](https://github.com/aiqualitylab/ai-natural-language-tests) ⭐ 15 | 🐛 3 | 🌐 Python | 📅 2026-04-27 - Generates Cypress and Playwright E2E tests from natural language requirements using LangGraph, ChromaDB, and multi-provider LLM support.
...
* [Captura](https://github.com/MathewSachin/Captura) ⭐ 10,659 | 🐛 114 | 🌐 C# | 📅 2026-04-10 - Open-source video recording tool.
...
* [Learn to Code](https://github.com/karlhorky/learn-to-program) ⭐ 4,769 | 🐛 23 | 📅 2025-05-10 - Another awesome list for developer training
...
* [Naughty Strings](https://github.com/minimaxir/big-list-of-naughty-strings) ⭐ 47,630 | 🐛 108 | 🌐 Python | 📅 2024-04-18 - This is the famous list of Naughty Strings. If you're doing some field validation, look no further for inspiration.
* [Falsehoods](https://github.com/kdeldycke/awesome-falsehood) ⭐ 27,325 | 🐛 3 | 📅 2026-04-27 - A funny and educational list of why nothing in Software Development is ever easy. Think you can store a marriage in a DB?
* [Unicode](https://github.com/jagracey/Awesome-Unicode) ⭐ 971 | 🐛 8 | 🌐 JavaScript | 📅 2022-07-01 - A great resource for learning how unicode works and the issues it can cause.

### Useful References

* [The Original](https://github.com/sindresorhus/awesome) ⭐ 460,012 | 🐛 67 | 📅 2026-04-19 - The awesome list of awesome lists.
* [Security](https://github.com/sbilly/awesome-security) ⭐ 14,270 | 🐛 203 | 📅 2026-01-11 - This is mostly focused on Infrastructure, but if you're testing a series of systems, this is very useful.
* [Application Security](https://github.com/paragonie/awesome-appsec) ⭐ 6,897 | 🐛 35 | 🌐 PHP | 📅 2025-02-22 - Incredibly extensive, but you'll find something to fit the bill.
* [How They Test](https://github.com/abhivaikar/howtheytest) ⭐ 6,728 | 🐛 8 | 🌐 TypeScript | 📅 2026-04-16 - A curated collection of public resources from tech companies on how they test their software and build a quality culture
* [Learn to Code](https://github.com/karlhorky/learn-to-program) ⭐ 4,769 | 🐛 23 | 📅 2025-05-10 - Learning to code, for those looking to make the move to automation
...
* [Selenium](https://github.com/christian-bromann/awesome-selenium) ⭐ 1,123 | 🐛 1 | 📅 2026-03-17 - Better than searching Google if you know what you want.
* [Awesome JMeter](https://github.com/aliesbelik/awesome-jmeter) ⭐ 786 | 🐛 0 | 🌐 HTML | 📅 2026-03-09 - A curated collection of resources around Apache JMeter.
...
* [Awesome Performance Engineering](https://github.com/be-next/awesome-performance-engineering) ⭐ 22 | 🐛 0 | 📅 2026-04-27 - A curated collection of tools and resources for performance engineering, covering observability and performance testing.

## QA and Testing Road Map

* [How to start QA and Testing career](https://github.com/fityanos/Quality-Assurance-Road-Map) ⭐ 2,102 | 🐛 8 | 📅 2021-12-30 - A wide and rich list of strategies, topics, and skills that you need to start a career in software testing and automation.
...
contributors](https://github.com/TheJambo/awesome-testing/graphs/contributors) ⭐ 2,256 | 🐛 2 | 📅 2026-04-22
